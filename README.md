...
- Version 1.2.1 : le panneau confirme explicitement la réception de `/mc show` et son affichage dans le chat. L'alias `/midnightcompanion show` est également disponible pour diagnostiquer un conflit de commande.
