...
- Mode sans frame : aucune frame, aucun événement, aucune sauvegarde et aucune UI n'est chargée. `/mc show` rafraîchit à la demande la classe, la spécialisation et le rôle via les API publiques.
