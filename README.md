...
- Version 1.3 : panneau nommé et explicitement rendu au premier plan avec fond opaque et titre fixe. Le chat confirme toujours la réception de `/mc show` pour faciliter le diagnostic.
